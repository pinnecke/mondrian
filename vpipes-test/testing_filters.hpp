...
TEST(TESTfilters, BasicFiltersTest) {
    ...
    mondrian::vpipes::point_copy<size_t>::func_t ids_copier = [](size_t *out, const size_t *tupletids,
                                                                 size_t num_of_ids) {
    ...
    mondrian::vpipes::pipes::filter<size_t> filter_nums_more_5(&mat,
                                                               mondrian::vpipes::predicates::batched_predicates<size_t>
                                                               ::greater_equal::micro_optimized_impl(predicate_value,
                                                                                                     true), batch_size);

    testing_vpipes_classes::minimal_reader<size_t> reader(&filter_nums_more_5,
                                                          mondrian::vpipes::predicates::batched_predicates<size_t>
                                                          ::greater_equal::micro_optimized_impl(0, true), input_length,
...
TEST(TESTfilters, CascadingFilters) {
    ...
    mondrian::vpipes::pipes::filter<size_t> filter_nums_more_5(&mat,
                                                               mondrian::vpipes::predicates::batched_predicates<size_t>
                                                               ::greater_equal::micro_optimized_impl(5, true),
                                                               batch_size);

    mondrian::vpipes::pipes::filter<size_t> filter_nums_less_20(&filter_nums_more_5,
                                                                mondrian::vpipes::predicates::batched_predicates<size_t>
                                                                ::less_equal::micro_optimized_impl(30, true),
                                                                batch_size);


    testing_vpipes_classes::minimal_reader<size_t> reader(&filter_nums_less_20,
                                                          mondrian::vpipes::predicates::batched_predicates<size_t>
                                                          ::greater_equal::micro_optimized_impl(0, true), input_length,
                                                          batch_size, batch_size);
...
TEST(TESTfilters, NoConditionSatisfied) {
    ...
    mondrian::vpipes::pipes::filter<size_t> filter_nums_more_100(&mat,
                                                                 mondrian::vpipes::predicates::batched_predicates<size_t>
                                                                 ::greater_equal::micro_optimized_impl(predicate_value,
                                                                                                       true),
                                                                 batch_size);

    testing_vpipes_classes::minimal_reader<size_t> reader(&filter_nums_more_100,
                                                          mondrian::vpipes::predicates::batched_predicates<size_t>
                                                          ::greater_equal::micro_optimized_impl(0, true), input_length,
                                                          batch_size, batch_size);
