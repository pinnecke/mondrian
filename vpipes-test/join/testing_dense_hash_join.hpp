 ...
 */
TEST(TestDenseHashJoin, TestEquiJoinNoneNull)
{
    ...
    mondrian::vpipes::bi_pipes::dense_map_hash_join <size_t> dense_join (&tee_op, batch_size, 150);

    auto rhs_table = pipes::table_scan<size_t >(dense_join.get_inner_operand(), &all_tuplet_ids, &all_tuplet_ids + 1,mondrian::vpipes::predicates::batched_predicates<size_t >
    ...
    auto lhs_table = pipes::table_scan<size_t >(dense_join.get_outer_operand(), &all_tuplet_ids, &all_tuplet_ids + 1,mondrian::vpipes::predicates::batched_predicates<size_t >
                                                ::greater_equal::micro_optimized_impl(predicate_value,true),
                                                null_value_filter_policy::skip_null_values,
    ...
    EXPECT_EQ(20, dense_join.get_join_statistics()->count_join_pairs);
    EXPECT_EQ(6, dense_join.get_join_statistics()->count_non_null_branch_used);
    EXPECT_EQ(0, dense_join.get_join_statistics()->count_null_values);
    EXPECT_EQ(0, dense_join.get_join_statistics()->count_null_branch_used);
 ...
 *      vals: it will take only one value 7 ... the ID which contains 7 in the right hand column
 */
TEST(TestDenseHashJoin, TestEquiJoinNull)
{
    ...
    mondrian::vpipes::bi_pipes::dense_map_hash_join<size_t> dense_join (&tee_op,batch_size, 500);
    ...
    EXPECT_EQ(9, dense_join.get_join_statistics()->count_join_pairs);
    EXPECT_EQ(3, dense_join.get_join_statistics()->count_non_null_branch_used);
    EXPECT_EQ(11, dense_join.get_join_statistics()->count_null_values);
    EXPECT_EQ(3, dense_join.get_join_statistics()->count_null_branch_used);
 ...
 */
TEST(TestDenseHashJoin, TestEquiJoinDiffLengthColumns)
{
    ...
    mondrian::vpipes::bi_pipes::dense_map_hash_join<size_t> dense_join (&tee_op,batch_size, 110);
    ...
    auto lhs_table = pipes::table_scan<size_t >(dense_join.get_outer_operand(), &all_tuplet_ids2, &all_tuplet_ids2 + 1,mondrian::vpipes::predicates::batched_predicates<size_t >
                                                ::greater_equal::micro_optimized_impl(predicate_value,true),
                                                null_value_filter_policy::skip_null_values,
                                                loc_block_copy, loc_block_null_copy, batch_size, batch_size, true);
    ...
    EXPECT_EQ(9, dense_join.get_join_statistics()->count_join_pairs);
    EXPECT_EQ(4, dense_join.get_join_statistics()->count_non_null_branch_used);
    EXPECT_EQ(0, dense_join.get_join_statistics()->count_null_values);
    EXPECT_EQ(0, dense_join.get_join_statistics()->count_null_branch_used);
    EXPECT_EQ(true, has_same_vals(expected_ids, ids_result, ids_res_length));
