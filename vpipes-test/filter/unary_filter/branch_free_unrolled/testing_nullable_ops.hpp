...
TEST(TestNullableOps, TestUseNullCheckingUnrolledBranchFreeFilter)
{
    ...
    auto eval_impl = batched_predicates<size_t>::greater_equal::micro_unrolled_branch_free_predicate(0, true);
...
TEST(TestNullableOps, TestSkipNullCheckingUnrolledBranchFreeFilter)
{
    using namespace mondrian::vpipes::pipes;
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;
...
unrolled_outcome unrolled_run_filter(size_t INPUT_DATA_LENGTH, size_t BATCH_SIZE,
...
/**
 * Test: Passing null-masked untouched through the pipe using unrolled branch free filter implementation that skip
 ...
 */
TEST(TestNullableOps, TestForwardNullMaskAllNonNullUnrolledBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestForwardNullMaskAllNonNullUnrolledBranchFreeFilter'..." << std::endl;

    auto result = unrolled_run_filter(20,    // Input data size
                             9,     // Batch size
                             batched_predicates<size_t>::greater_equal::micro_unrolled_branch_free_predicate(0, true), // Predicate
                             [&] (smart_bitmask *null_mask, const mondrian::mtl::smart_array<size_t> *null_mask_indices,
                                  const mondrian::mtl::smart_array<tuplet_id_t> *tuplet_ids)
                             {
...
/**
 * Test: Passing null-masked untouched through the pipe using unrolled branchfree filter implementation that skip
 ...
 *      -   3 batches should be materialized with a result buffer length of 20
 */
TEST(TestNullableOps, TestForwardNullMaskAllNullUnrolledBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestForwardNullMaskAllNullUnrolledBranchFreeFilter'..." << std::endl;
...
/**
 * Test: Passing null-masked untouched through the pipe using UnrolledBranchFree filter implementation that skip
 ...
 *      -   3 batches should be materialized with a result buffer length of 20
 */
TEST(TestNullableOps, TestForwardNullMaskSomeNullUnrolledBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestForwardNullMaskSomeNullUnrolledBranchFreeFilter'..." << std::endl;
...
/**
 * Test: Passing null-masked untouched through the pipe using unrolled branchfree filter implementation that removes
 *       null values. All elements are non-null.
 *
 * With the following test-set, having a batch size of 9, a 100% selective filter and no deletion of nulls:
 *
 ...
 *      -   3 batches should be materialized with a result buffer length of 20
 */
TEST(TestNullableOps, TestRemoveNullMaskAllNonNullUnrolledBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestRemoveNullMaskAllNonNullUnrolledBranchFreeFilter'..." << std::endl;
 ...
 */
TEST(TestNullableOps, TestRemoveNullMaskAllNullUnrolledBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestRemoveNullMaskAllNullUnrolledBranchFreeFilter'..." << std::endl;
 ...
 */
TEST(TestNullableOps, TestRemoveNullMaskSomeNullUnrolledBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestRemoveNullMaskSomeNullUnrolledBranchFreeFilter'..." << std::endl;
 ...
 *      -   2 batches should be materialized with a result buffer length of 13
 */
TEST(TestNullableOps, TestComplexRemoveNullUnrolledBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestComplexRemoveNullUnrolledBranchFreeFilter'..." << std::endl;

    auto result = unrolled_run_filter(200,    // Input data size
                             66,     // Batch size
                             batched_predicates<size_t>::greater_equal::micro_unrolled_branch_free_predicate(1, true), // Predicate
                             [&] (smart_bitmask *null_mask, const mondrian::mtl::smart_array<size_t> *null_mask_indices,
                                  const mondrian::mtl::smart_array<tuplet_id_t> *tuplet_ids)
                             {
                                 for (int i = 0; i < null_mask_indices->get_num_elements(); i += 3) {
...
/**
 * Test: Passing null-masked untouched through the pipe using unrolled branchfree filter implementation that passes
 *       null values. Some elements are null.
 *
 * With the following test-set, having a batch size of 9, a non-100% selective filter and no deletion of nulls:
 *
 ...
 *      -   2 batches should be materialized with a result buffer length of 13
 */
TEST(TestNullableOps, TestComplexPassNullUnrolledBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestComplexPassNullUnrolledBranchFreeFilter'..." << std::endl;
