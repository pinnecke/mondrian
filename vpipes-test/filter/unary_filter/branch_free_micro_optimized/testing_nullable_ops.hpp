...
TEST(TestNullableOps, TestUseNullCheckingMicroBranchFreeFilter)
{
    ...
    auto eval_impl = batched_predicates<size_t>::greater_equal::micro_branch_free_predicate(0, true);
...
TEST(TestNullableOps, TestSkipNullCheckingMicroBranchFreeFilter)
{
    using namespace mondrian::vpipes::pipes;
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;
...
branchfree_outcome branchfree_run_filter(size_t INPUT_DATA_LENGTH, size_t BATCH_SIZE,
...
/**
 * Test: Passing null-masked untouched through the pipe using micro branchfree filter implementation that skip
 ...
 */
TEST(TestNullableOps, TestForwardNullMaskAllNonNullMicroBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestForwardNullMaskAllNonNullMicroBranchFreeFilter'..." << std::endl;

    auto result = branchfree_run_filter(20,    // Input data size
                             9,     // Batch size
                             batched_predicates<size_t>::greater_equal::micro_branch_free_predicate(0, true), // Predicate
                             [&] (smart_bitmask *null_mask, const mondrian::mtl::smart_array<size_t> *null_mask_indices,
                                  const mondrian::mtl::smart_array<tuplet_id_t> *tuplet_ids)
                             {
 ...
 *      -   3 batches should be materialized with a result buffer length of 20
 */
TEST(TestNullableOps, TestForwardNullMaskAllNullMicroBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestForwardNullMaskAllNullMicroBranchFreeFilter'..." << std::endl;
 ...
 *      -   3 batches should be materialized with a result buffer length of 20
 */
TEST(TestNullableOps, TestForwardNullMaskSomeMicroBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestForwardNullMaskSomeNullMicroBranchFreeFilter'..." << std::endl;
...
/**
 * Test: Passing null-masked untouched through the pipe using micro branchfree filter implementation that removes
 *       null values. All elements are non-null.
 *
 * With the following test-set, having a batch size of 9, a 100% selective filter and no deletion of nulls:
 *
 ...
 *      -   3 batches should be materialized with a result buffer length of 20
 */
TEST(TestNullableOps, TestRemoveNullMaskAllNonNullMicroBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestRemoveNullMaskAllNonNullMicroBranchFreeFilter'..." << std::endl;
 ...
 */
TEST(TestNullableOps, TestRemoveNullMaskAllNullMicroBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestRemoveNullMaskAllNullMicroBranchFreeFilter'..." << std::endl;
 ...
 */
TEST(TestNullableOps, TestRemoveNullMaskSomeNullMicroBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestRemoveNullMaskSomeNullMicroBranchFreeFilter'..." << std::endl;
 ...
 *      -   2 batches should be materialized with a result buffer length of 13
 */
TEST(TestNullableOps, TestComplexRemoveNullMicroBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestComplexRemoveNullMicroBranchFreeFilter'..." << std::endl;

    auto result = branchfree_run_filter(200,    // Input data size
                             66,     // Batch size
                             batched_predicates<size_t>::greater_equal::micro_branch_free_predicate(1, true), // Predicate
                             [&] (smart_bitmask *null_mask, const mondrian::mtl::smart_array<size_t> *null_mask_indices,
                                  const mondrian::mtl::smart_array<tuplet_id_t> *tuplet_ids)
                             {
                                 for (int i = 0; i < null_mask_indices->get_num_elements(); i += 3) {
...
/**
 * Test: Passing null-masked untouched through the pipe using micro branchfree filter implementation that passes
 *       null values. Some elements are null.
 *
 * With the following test-set, having a batch size of 9, a non-100% selective filter and no deletion of nulls:
 *
 ...
 *      -   2 batches should be materialized with a result buffer length of 13
 */
TEST(TestNullableOps, TestComplexPassNullMicroBranchFreeFilter)
{
    using namespace mondrian::vpipes::predicates;
    using namespace mondrian::mtl;

    std::cout << "\n\n>>> Test 'TestComplexPassNullMicroBranchFreeFilter'..." << std::endl;
