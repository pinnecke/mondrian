...
namespace mondrian
{
    namespace vpipes
    {
        namespace bi_pipes
        {
            ...
            class sparse_map_hash_join : public bi_pipe<Input, Input>
            {
            ...
            private:
                ...
                google::sparse_hash_map <output_t, vector<input_t> > join_map;

            public:
                sparse_map_hash_join (__in__ consumer_t *destination,
