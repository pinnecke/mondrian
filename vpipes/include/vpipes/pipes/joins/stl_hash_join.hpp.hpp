...
namespace mondrian
{
    namespace vpipes
    {
        namespace bi_pipes
        {
            ...
            class stl_hash_join : public bi_pipe<Input, Input>
            {
            ...
            private:
                ...
                unordered_map<output_t, vector<input_t> > join_map;

            public:
                stl_hash_join (__in__ consumer_t *destination,
                ...
                {
                    return "vpipes::pipes::stl_hash_join";
                }
