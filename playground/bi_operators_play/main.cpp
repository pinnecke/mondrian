...
int main() {
    ...
    interval<size_t> all_tuplet_ids2(0, 4);
    ...
    auto loc_table = pipes::table_scan<size_t >(b_join.get_left_operator(), &all_tuplet_ids, &all_tuplet_ids + 1,mondrian::vpipes::predicates::batched_predicates<size_t >
    ...
    auto loc_table2 = pipes::table_scan<size_t >(b_join.get_right_operator(), &all_tuplet_ids2, &all_tuplet_ids2 + 1,mondrian::vpipes::predicates::batched_predicates<size_t >
                                                ::greater_equal::micro_optimized_impl(predicate_value,true),
                                                null_value_filter_policy::skip_null_values,
